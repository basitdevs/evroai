    ...
    <section className='py-16 lg:py-24'>
      <div className='max-w-[1550px] mx-auto px-6 lg:px-8'>
        <div className='text-center max-w-4xl mx-auto'>
          <p className='text-lg font-semibold text-[#00C4CC]'>AI Assistants Library</p>
          ...
          <h2 className='mt-6 text-lg lg:text-xl text-gray-900 leading-relaxed'>
        ...
        <div className='mt-20 lg:mt-24 max-w-4xl mx-auto text-center'>
          ...
          <h2 className='mt-16 text-3xl lg:text-5xl font-bold font-heading text-gray-900'>
        ...
        <div className='mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
          {exampleAssistants.map((assistant, index) => (
            <div key={index} className='bg-gray-50 p-6 rounded-xl border border-gray-200'>
              <div className='text-[#00C4CC] mb-4'>{assistant.icon}</div>
