...
export const MissionAndValues = React.forwardRef<HTMLElement>((_, ref) => {
  return (
    <section ref={ref} className='py-16 lg:py-24 bg-black rounded-t-[25px] md:rounded-t-[40px]'>
      <div className='max-w-[1550px] mx-auto px-6 lg:px-8'>
        <div className='text-center max-w-6xl mx-auto'>
          <h1 className='text-[32px] md:text-[58px] font-heading font-semibold uppercase font-heading text-white leading-[1]'>
        ...
        <div className='mt-20 lg:mt-24'>
          <div className='text-center'>
            <h2 className='text-4xl lg:text-5xl uppercase font-bold font-heading text-white'>
              Values
            </h2>
          </div>
          ...
          <div className='mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8'>
            {valuesData.map((value, index) => (
              <div
                key={index}
                className='bg-[#101010] p-8 rounded-2xl border border-gray-900 text-center'
              >
                ...
                <p className='mt-3 text-gray-300  text-lg lg:text-xl leading-relaxed'>
                  {value.description}
                </p>
              </div>
            ))}
